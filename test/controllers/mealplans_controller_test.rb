...
class MealplansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mealplan" do
    assert_difference("Mealplan.count") do
      post mealplans_url, params: { mealplan: { code: @mealplan.code, effective_date: @mealplan.effective_date, name: @mealplan.name } }
    end
  ...
  test "should update mealplan" do
    patch mealplan_url(@mealplan), params: { mealplan: { code: @mealplan.code, effective_date: @mealplan.effective_date, name: @mealplan.name } }
